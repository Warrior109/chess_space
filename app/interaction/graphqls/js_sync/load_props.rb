...
# .
class Graphqls::JsSync::LoadProps < ApplicationInteraction
  ...
  def execute # rubocop:disable Metrics/AbcSize
    ...
    query_names = compose(
      LoadQueryNames, data: file_api_data, queries_folder_name: QUERIES_FOLDER_NAME
    )
    queries = compose(
      LoadQueries,
      query_names: query_names, queries_folder_path: core_path.join(QUERIES_FOLDER_NAME)
    )
